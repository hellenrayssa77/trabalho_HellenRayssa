...
const salvarProduto = (e) => {
  ...
  const preencherTabela = () =>{
      ...
      for(const produto of produtos){
          ...
          <td>
          <img type="button" width="40" src=" ./img/icons8-delete-48.png" onclick="removerProduto(${produto.id})" />
          <img type= "button" width="40" src=" ./img/icons8-edit-48.png" onclick="editarProduto(${produto.id})" />
          </tr>
